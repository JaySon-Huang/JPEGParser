...
public class ThreadPool {
    ...
    private static ThreadFactory threadFactory = new ThreadFactory() {
        private final AtomicInteger mThreadCnt = new AtomicInteger();

        @Override
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, "ThreadPool thread:" + mThreadCnt.getAndIncrement());
        }
    };
